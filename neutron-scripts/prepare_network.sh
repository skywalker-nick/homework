...
subnet_id=`neutron --os-tenant-name $tenant --os-username $user --os-password password --os-auth-url=http://localhost:5000/v2.0 subnet-create $tenant-Net 10.25.0.0/24 | awk '$2~/^id/{print $4}'`
...
neutron router-gateway-set $tenant-R1 $extnet
